...
/**
 * PrunedFilteredVectorizedHiveDataSourceReader implements interfaces needed for pushdowns and pruning.
 *
 ...
 */
public class PrunedFilteredVectorizedHiveDataSourceReader
    extends VectorizedHiveDataSourceReaderWithFilterPushDown
    implements SupportsPushDownRequiredColumns {

  public PrunedFilteredVectorizedHiveDataSourceReader(Map<String, String> options) {
    super(options);
  }
