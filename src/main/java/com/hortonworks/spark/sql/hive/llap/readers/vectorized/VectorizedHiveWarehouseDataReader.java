...
public class VectorizedHiveWarehouseDataReader implements DataReader<ColumnarBatch> {
  ...
  public VectorizedHiveWarehouseDataReader(LlapInputSplit split,
                                           JobConf conf,
    ...
    this.reader = JobUtil.getLlapArrowBatchRecordReader(split, conf, arrowAllocatorMax, attemptId);
  }
