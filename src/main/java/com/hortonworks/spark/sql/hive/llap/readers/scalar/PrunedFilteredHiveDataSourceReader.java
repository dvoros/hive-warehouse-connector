...
import com.hortonworks.spark.sql.hive.llap.readers.vectorized.VectorizedHiveDataSourceReaderWithFilterPushDown;
 ...
 * 5. Spark pulls factories, where factory/task are 1:1 -> createDataReaderFactories(..)
 */
