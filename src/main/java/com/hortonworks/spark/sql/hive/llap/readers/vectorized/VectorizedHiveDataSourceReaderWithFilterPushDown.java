 ...
 * 4. Spark pulls factories, where factory/task are 1:1 -> createBatchDataReaderFactories(..)
 */
public class VectorizedHiveDataSourceReaderWithFilterPushDown extends VectorizedHiveWarehouseDataSourceReader
  ...
  public VectorizedHiveDataSourceReaderWithFilterPushDown(Map<String, String> options) {
    super(options);
  }
