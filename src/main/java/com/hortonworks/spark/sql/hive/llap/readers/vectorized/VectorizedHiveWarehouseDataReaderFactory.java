...
public class VectorizedHiveWarehouseDataReaderFactory implements DataReaderFactory<ColumnarBatch> {
    ...
    public VectorizedHiveWarehouseDataReaderFactory() {}

    //Driver-side setup
    public VectorizedHiveWarehouseDataReaderFactory(InputSplit split, byte[] serializedJobConf, long arrowAllocatorMax,
    ...
    protected DataReader<ColumnarBatch> getDataReader(LlapInputSplit split, JobConf jobConf, long arrowAllocatorMax, CommonBroadcastInfo commonBroadcastInfo)
        throws Exception {
        return new VectorizedHiveWarehouseDataReader(split, jobConf, arrowAllocatorMax, commonBroadcastInfo);
    }
}
